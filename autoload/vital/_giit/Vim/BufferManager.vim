...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_giit#Vim#BufferManager#import() abort
  ...
  execute join(['function! vital#_giit#Vim#BufferManager#import() abort', printf("return map({'_vital_depends': '', 'new': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
" buffer manager.
