...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_giit#Vim#Prompt#import() abort
  ...
  execute join(['function! vital#_giit#Vim#Prompt#import() abort', printf("return map({'ask': '', 'clear': '', 'capture': '', 'echomsg': '', 'echo': '', 'confirm': '', 'input': '', 'set_config': '', 'error': '', 'select': '', 'get_config': '', 'is_debug': '', 'warn': '', 'inputlist': '', 'is_batch': '', 'debug': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
