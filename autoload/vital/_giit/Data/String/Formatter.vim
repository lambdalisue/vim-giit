...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_giit#Data#String#Formatter#import() abort
  ...
  execute join(['function! vital#_giit#Data#String#Formatter#import() abort', printf("return map({'format': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:t_string = type('')
